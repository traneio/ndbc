...
public class ConfigTest {
  ...
  private final Charset charset                       = Charset.availableCharsets().values()
      .stream()
  ...
  public void poolMaxWaitersOptionalPresent() {
    final Config c = Config.apply(dataSourceSupplierClass, host, port, user);
    final int poolMaxWaiters = 100;
    assertEquals(Optional.of(poolMaxWaiters),
        c.poolMaxWaiters(Optional.of(poolMaxWaiters)).poolMaxWaiters());
  }
  ...
  public void encodingClasses() {
    ...
    assertEquals(Optional.of(encodingClasses),
        c.encodingClasses(encodingClasses).encodingClasses());
  }
  ...
  public void encodingClassesOptionalPresent() {
    ...
    encodingClasses.add("some.Class");
    assertEquals(Optional.of(encodingClasses),
        c.encodingClasses(Optional.of(encodingClasses)).encodingClasses());
  }
  ...
  public void addEncodingClassEmpty() {
    ...
    final Optional<Set<String>> encodingClasses = c.addEncodingClass(encodingClass)
        .encodingClasses();
  ...
  public void fromPropertiesPoolValidationIntervalSeconds() {
    ...
    p.setProperty("db.port", Integer.toString(port));
    p.setProperty("db.user", user);
    p.setProperty("db.poolValidationIntervalSeconds",
        Integer.toString(poolValidationIntervalSeconds));
    final Config c = Config.fromProperties("db", p);
    assertEquals(c.poolValidationInterval(),
        Optional.of(Duration.ofSeconds(poolValidationIntervalSeconds)));
  }
