...
public final class BufferReader implements io.trane.ndbc.proto.BufferReader {
  ...
  @Override
  public final String readCString(final Charset charset) {
  ...
  @Override
  public final String readCString(final int length, final Charset charset) {
  ...
  @Override
  public final String readString(final Charset charset) {
    return readString(bb.readableBytes(), charset);
  }

  @Override
  public final String readString(final int length, final Charset charset) {
