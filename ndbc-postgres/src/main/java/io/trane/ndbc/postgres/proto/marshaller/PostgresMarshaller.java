...
// TODO delete
public class PostgresMarshaller implements MarshallerRegistry {
  ...
  public final void encode(final ClientMessage msg, final BufferWriter b) {
    try {
      if (msg instanceof Bind)
        bindMarshaller.apply((Bind) msg, b);
      else if (msg instanceof CancelRequest)
        cancelRequestMarshaller.apply((CancelRequest) msg, b);
      else if (msg instanceof Close)
        closeMarshaller.apply((Close) msg, b);
        ...
        describeMarshaller.apply((Describe) msg, b);
      else if (msg instanceof Execute)
        executeMarshaller.apply((Execute) msg, b);
      else if (msg instanceof Flush)
        flushMarshaller.apply((Flush) msg, b);
      else if (msg instanceof FunctionCall)
        notImplemented(FunctionCall.class);
      else if (msg instanceof Parse)
        parseMarshaller.apply((Parse) msg, b);
      else if (msg instanceof Query)
        queryMarshaller.apply((Query) msg, b);
      else if (msg instanceof PasswordMessage)
        passwordMessageMarshaller.apply((PasswordMessage) msg, b);
      else if (msg instanceof SSLRequest)
        sslRequestMarshaller.apply((SSLRequest) msg, b);
      else if (msg instanceof StartupMessage)
        startupMessageMarshaller.apply((StartupMessage) msg, b);
      else if (msg instanceof Sync)
        syncMarshaller.apply((Sync) msg, b);
      else if (msg instanceof Terminate)
        terminateMarshaller.apply((Terminate) msg, b);
      else
