...
public class HandshakeTest {
  ...
  public void handShakeAndQuery() throws IOException {
    ...
    HandshakeResponseMessage handshakeResponsePacketMessage =
            new HandshakeResponseMessage(serverHandshake.sequence + 1, "root", Optional.of("mysql"), Optional.of("mysql"), "utf8", serverHandshake.seed, "mysql_native_password");
  ...
  public void initalHandshakePacket() {
    byte[] binary = {(byte) 0x36, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x0a, (byte) 0x35, (byte) 0x2e, (byte) 0x35, (byte) 0x2e, (byte) 0x32, (byte) 0x2d, (byte) 0x6d, (byte) 0x32, (byte) 0x00, (byte) 0x0b, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x64, (byte) 0x76, (byte) 0x48, (byte) 0x40, (byte) 0x49, (byte) 0x2d, (byte) 0x43, (byte) 0x4a, (byte) 0x00, (byte) 0xff, (byte) 0xf7, (byte) 0x21, (byte) 0x02, (byte) 0x00,
            (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x2a, (byte) 0x34, (byte) 0x64,
            (byte) 0x7c, (byte) 0x63, (byte) 0x5a, (byte) 0x77, (byte) 0x6b, (byte) 0x34, (byte) 0x5e, (byte) 0x5d, (byte) 0x3a, (byte) 0x00};
  ...
  public void handshakeResponsePacket() {
    ...
    HandshakeResponseMessage handshakeResponsePacketMessage =
            new HandshakeResponseMessage(1, "username", Optional.of("password"), Optional.empty(), "utf8", salt, "mysql_native_password");
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    TestSyncBufferWriter bw = new TestSyncBufferWriter(baos, utf8);
    handshakeResponsePacketMarshaller.encode(handshakeResponsePacketMessage, bw, utf8);

    PacketBufferReader packet = new PacketBufferReader(new TestSyncBufferReader(new ByteArrayInputStream(baos.toByteArray()), utf8));
