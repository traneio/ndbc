...
public class StartupExchange {
  ...
  public StartupExchange(final SimpleQueryExchange simpleQueryExchange, final Marshallers marshallers,
      final Unmarshallers unmarshallers, final Exchange<Void> okPacketVoid) {
  ...
  private Function<Handshake, Exchange<Void>> doHandshake(final String username, final Optional<String> password,
