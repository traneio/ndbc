...
// final PartialFunction<ServerMessage, Exchange<TestServerMessage>> f =
// PartialFunction
...
// final int actual = Exchange.value(expected).run(new
// TestChannel()).get(timeout);
// assertEquals(expected, actual);
// }
//
// @Test
// public void map() throws CheckedFutureException {
// assertEquals(new Integer(2), Exchange.value(1).map(i -> i + 1).run(new
// TestChannel()).get(timeout));
// }
//
// @Test
...
// Exchange.value(1).flatMap(i -> Exchange.value(i + 1)).run(new
// TestChannel()).get(timeout));
// }
//
// @Test
...
// assertEquals(new Integer(2),
// Exchange.value(1).then(Exchange.value(2)).run(new
// TestChannel()).get(timeout));
// }
//
// @Test
...
// };
// assertEquals(msg,
// Exchange.value(1).thenReceive(f).run(channel).get(timeout));
// }
//
// @Test(expected = RuntimeException.class)
